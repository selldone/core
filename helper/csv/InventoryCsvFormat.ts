...
/**
 * Canonical header order for full inventory import/export files.
 */
...
/**
 * Column metadata used by the inventory CSV editor/import wizard.
 */
...
/**
 * Describes a supported inventory import template.
 */
...
/**
 * Supported inventory import templates keyed by template code.
 */
...
/**
 * Checks whether all mandatory headers are present.
 */
...
/**
 * Checks whether uploaded headers contain only allowed mandatory/optional columns.
 */
...
/**
 * Validation and auto-detection helpers for inventory CSV files.
 */
export class InventoryCsvFormat {
  /**
   * Detects the most suitable inventory import template for a given header list.
   * @param {string[]} headers - Parsed CSV headers.
   * @returns {InventoryImportTypeStructure} Matching import template.
   */
  ...
  /**
   * Last validation error generated by `CheckValidFile`.
   */
  static LastError: string | null = null;

  /**
   * Validates a header list against a selected inventory import template.
   * @param {string[]} headers - Parsed CSV headers.
   * @param {InventoryImportTypeStructure} inventory_import_type - Expected template.
   * @returns {boolean} True when all required headers exist.
   */
