...
export class ClassesHelper {
  ...
  /*
    static StandardClassessssssssss(){
        ...
        // Margins:
        out.push({title:'Margin',items:this.AutoGenerateResponsive('ma-',0,16)})
        out.push({title:'Margin Top',items:this.AutoGenerateResponsive('mt-',0,16)})
        out.push({title:'Margin Bottom',items:this.AutoGenerateResponsive('mb-',0,16)})
        out.push({title:'Margin start',items:this.AutoGenerateResponsive('ms-',0,16)})
        out.push({title:'Margin End',items:this.AutoGenerateResponsive('me-',0,16)})



        // Extra:
        out.push({title:'Extra',items:['is-black']})
