...
export class CurrencyHelper {
    ...
    static GetUserSelectedCurrencyFactor(
        ...
        const currency_obj = isObject(current_currency) ? current_currency : Currency[current_currency];

        return currency_obj?.alt_name
            ? currency_obj.alt_factor!
            : 1;
    }
    ...
    static GetUserSelectedCurrencyFloats(
        ...
        return isObject(current_currency) ? current_currency.floats : Currency[current_currency]?.floats;
    }
    ...
    static GetUserSelectedCurrencyRoundFactor(
        ...
        return isObject(current_currency) ? current_currency.round_factor : Currency[current_currency]?.round_factor;
    ...
    static GetUserSelectedCurrencyFormat(
        ...
        return isObject(current_currency) ? current_currency.format : Currency[current_currency]?.format;
    ...
    static GetUserSelectedCurrencyUnicode(
        ...
        return isObject(current_currency) ? current_currency.unicode : Currency[current_currency]?.unicode;
    ...
    static GetUserSelectedCurrencySignAtEnd(
        ...
        return !!(isObject(current_currency) ? current_currency.at_end : Currency[current_currency]?.at_end);
