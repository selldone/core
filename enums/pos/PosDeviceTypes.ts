...
export const PosDeviceTypes = {
  Scanner: {
    ...
    src: require("@components/assets/icons/barcode-scanner.svg"),
    enable: true,
  },
  Printer: {
    code: "Printer",
    ...
    src: require("@components/assets/icons/label-printer.svg"),
    enable: false,
  },
  CustomerView: {
    code: "CustomerView",
    ...
    src: require("@components/assets/icons/pos-customer-view.svg"),
    enable: true,
  },
  CardReader: {
    code: "CardReader",
    ...
    src: require("@components/assets/icons/pos-card-reader.svg"),
    enable: false,
  },
  ChipReader: {
    code: "ChipReader",
    ...
    src: require("@components/assets/icons/tag-reader.svg"),
    enable: false,
  },
};
