...
export const HelpCategories = {
  ...
  Channel: { code: "Channel", name: "helps.categories.Channel" },
  Accounting: { code: "Accounting", name: "helps.categories.Accounting" },
  Incentives: { code: "Incentives", name: "helps.categories.Incentives" },
  Marketing: { code: "Marketing", name: "helps.categories.Marketing" },
  Logistic: { code: "Logistic", name: "helps.categories.Logistic" },
  Customers: { code: "Customers", name: "helps.categories.Customers" },
  Page: { code: "Page", name: "helps.categories.Page" },
