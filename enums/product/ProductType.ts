...
> = {
  PHYSICAL: {
    ...
    image: require("@core/assets/product-types/physical.svg"),
  ...
  VIRTUAL: {
    ...
    image: require("@core/assets/product-types/virtual.svg"),
  ...
  FILE: {
    ...
    image: require("@core/assets/product-types/file.svg"),
  ...
  SERVICE: {
    ...
    image: require("@core/assets/product-types/service.svg"),
  ...
  SUBSCRIPTION: {
    ...
    image: require("@core/assets/product-types/subscription.svg"),
