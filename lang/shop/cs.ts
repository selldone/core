export default {
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Vážíme si vašeho času, kdy jste nás kontaktovali. Vaše zpráva byla přijata a náš tým ji právě kontroluje. Odpovíme vám co nejdříve a děkujeme vám za trpělivost během této doby. Váš zájem a zpětná vazba jsou pro nás důležité a jsme odhodláni poskytovat vám tu nejlepší možnou podporu."
  },
  "master_payment": {
    "notifications": {
