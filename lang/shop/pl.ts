export default {
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Dziękujemy za poświęcony czas na skontaktowanie się z nami. Twoja wiadomość została otrzymana i nasz zespół obecnie ją przegląda. Odpowiemy tak szybko, jak to możliwe i dziękujemy za cierpliwość w tym czasie. Twoje zainteresowanie i opinie są dla nas ważne, dlatego dokładamy wszelkich starań, aby zapewnić Ci najlepsze możliwe wsparcie."
  },
  "master_payment": {
    "notifications": {
